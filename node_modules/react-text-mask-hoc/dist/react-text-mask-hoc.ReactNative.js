...
function (_PureComponent) {
  ...
  createClass(TextMask, [{
    ...
    value: function render() {
      ...
      return React.createElement(Component$$1, _extends({}, rest, {
...
var TextInputAdapter =
/*#__PURE__*/
function (_Component) {
  inherits(TextInputAdapter, _Component);
  ...
  function TextInputAdapter() {
    ...
    classCallCheck(this, TextInputAdapter);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = TextInputAdapter.__proto__ || Object.getPrototypeOf(TextInputAdapter)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_this, "_selection", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: void 0
    }), Object.defineProperty(_this, "_lastOnChangeEvent", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: void 0
    }), Object.defineProperty(_this, "_getRef", {
      configurable: true,
      enumerable: true,
      writable: true,
      ...
      value: function value(_ref2) {
        ...
        _this._lastOnChangeEvent = nativeEvent;
      }
    }), Object.defineProperty(_this, "_onSelectionChange", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(event) {
        _this._selection = event.nativeEvent.selection.end;

        if (_this._lastOnChangeEvent) {
          _this.props.onChange(_this._lastOnChangeEvent);

          _this._lastOnChangeEvent = undefined;
        }
      }
    }), _temp));
  }

  createClass(TextInputAdapter, [{
    ...
    key: "_setNativeProps",
    value: function _setNativeProps(value, caretPosition) {
...
Object.defineProperty(TextInputAdapter, "propTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
/*#__PURE__*/
function (_PureComponent) {
  inherits(TextAdapter, _PureComponent);

  function TextAdapter() {
    classCallCheck(this, TextAdapter);
    return possibleConstructorReturn(this, (TextAdapter.__proto__ || Object.getPrototypeOf(TextAdapter)).apply(this, arguments));
  }

  createClass(TextAdapter, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          value = _props.value,
          ...
          onChange = _props.onChange,
          rest = objectWithoutProperties(_props, ["value", "caretPosition", "onChange"]);
      return React.createElement(Text, rest, value);
    }
  }, {
    key: "caretPosition",
...
Object.defineProperty(TextAdapter, "propTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
export { TextMask, withTextMask, TextInputAdapter, TextAdapter, TextMaskTransformer };
//# sourceMappingURL=react-text-mask-hoc.ReactNative.js.map
