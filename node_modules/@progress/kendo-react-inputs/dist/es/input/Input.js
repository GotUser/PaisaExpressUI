...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.render = function () {
        ...
        return label
            ? (React.createElement(FloatingLabel, { label: label, children: textbox, value: String(this.value), placeholder: props.placeholder, id: inputId, valid: isValid, style: style }))
            : textbox;
    };
    /**
     * @hidden
