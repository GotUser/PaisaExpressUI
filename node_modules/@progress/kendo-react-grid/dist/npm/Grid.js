...
var Grid = /** @class */ (function (_super) {
    ...
    function Grid(props) {
        ...
        _this.scrollHandler = function (event) {
            ...
            kendo_react_common_1.dispatchEvent(_this.props.onScroll, event, _this, {});
        };
    ...
    Grid.prototype.render = function () {
        ...
        var data = [];
        var resolvedGroupsCount = index_1.flatData(data, propsData, footer, { index: this.props.skip || 0 }, this.props.group !== undefined, this.props.expandField);
