 ...
 * @hidden
 */
var ColumnMenuFilterCell = /** @class */ (function (_super) {
    __extends(ColumnMenuFilterCell, _super);
    function ColumnMenuFilterCell(props) {
     ...
     * @hidden
     */
    ColumnMenuFilterCell.prototype.render = function () {
        var _this = this;
        var value = this.props.operators.find(function (item) { return item.operator === _this.props.operator; }) || null;
        return (React.createElement("div", null,
            this.props.filterType !== 'boolean' && (React.createElement(kendo_react_dropdowns_1.DropDownList, { value: value, onChange: this.operatorChange, data: this.props.operators, textField: "text" })),
            this.filterComponent(this.props.filterType, this.props.value, this.props.operators)));
    };
    ColumnMenuFilterCell.prototype.inputChange = function (value, e) {
        filterCommon_1.cellInputChange(value, e, this.props);
    };
    ColumnMenuFilterCell.prototype.operatorChange = function (event) {
        filterCommon_1.cellOperatorChange(event, this.props.value, this.props.onChange);
    };
    ColumnMenuFilterCell.prototype.boolDropdownChange = function (event) {
        filterCommon_1.cellBoolDropdownChange(event, this.props.onChange);
    };
    ColumnMenuFilterCell.prototype.filterComponent = function (filterType, value, operators) {
        var _this = this;
        switch (filterType) {
            case 'numeric':
            ...
            case 'boolean':
                ...
                return (React.createElement(kendo_react_dropdowns_1.DropDownList, { onChange: this.boolDropdownChange, value: operators.find(function (item) { return item.operator === (noFilterSet_1(value) ? '' : value); }), data: operators, textField: "text" }));
    ...
    return ColumnMenuFilterCell;
}(React.Component));
exports.ColumnMenuFilterCell = ColumnMenuFilterCell;
//# sourceMappingURL=ColumnMenuFilterCell.js.map