...
var TimeList = /** @class */ (function (_super) {
    ...
    TimeList.prototype.componentDidMount = function () {
        ...
        this.dom.calculateHeights(this._element);
        this.forceUpdate();
    };
    /**
     * @hidden
    ...
    TimeList.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "k-time-list", id: String(this.props.id), tabIndex: 0, ref: function (el) { _this._element = el; }, onKeyDown: this.handleKeyDown, onFocus: this.handleFocus, onBlur: this.handleBlur, onMouseOver: this.handleMouseOver }, this.dom.didCalculate
            ...
            : (React.createElement("div", { className: "k-time-list-container" }, list))));
    };
    TimeList.propTypes = {
        id: PropTypes.number,
