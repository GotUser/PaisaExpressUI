 ...
 * The generic argument sets the event target type, defaults to `Calendar`.
 */
 ...
 * The generic argument is passed to the `onChange` property and is used as target in the [`CalendarChangeEvent`]({% slug api_dateinputs_calendarchangeevent %}) interface.
 */
