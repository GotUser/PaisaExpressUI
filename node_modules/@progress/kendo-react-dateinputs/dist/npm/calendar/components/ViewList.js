...
var ViewList = /** @class */ (function (_super) {
    ...
    ViewList.prototype.componentWillReceiveProps = function (nextProps) {
        var didViewChanged = this.props.activeView !== nextProps.activeView;
        this.animateToIndex = !didViewChanged;
        if (!didViewChanged
            && kendo_date_math_1.isEqualDate(this.props.focusedDate, nextProps.focusedDate)
            && !this.shouldScroll) {
            return;
        }
        var viewDate = utils_1.dateInRange(nextProps.focusedDate, nextProps.min, nextProps.max);
