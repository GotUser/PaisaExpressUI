...
/**
 * The arguments for the `onChange` event of the MultiViewCalendar.
 * The generic argument sets the event target type, defaults to `MultiViewCalendar`.
 */
 ...
 * The generic argument is passed to the `onChange` property and is used as target in the [`MultiViewCalendarChangeEvent`]({% slug api_dateinputs_multiviewcalendarchangeevent %}) interface.
 */
...
export declare class MultiViewCalendar extends React.Component<MultiViewCalendarProps, MultiViewCalendarState> {
     ...
     */
    static propTypes: {
        activeRangeEnd: PropTypes.Requireable<any>;
        allowReverse: PropTypes.Requireable<any>;
        bottomView: PropTypes.Requireable<any>;
        ...
        topView: PropTypes.Requireable<any>;
