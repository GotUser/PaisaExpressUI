...
var START_DATEINPUT_LABEL = 'Start';
var END_DATEINPUT_LABEL = 'End';
...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    DateRangePicker.prototype.render = function () {
        ...
        var startDateInputProps = __assign({ label: START_DATEINPUT_LABEL, format: this.props.format, min: this.min, max: this.max, id: this._startInputId, disabled: this.props.disabled }, this.props.startDateInputSettings, { value: value.start, onChange: this.handleStartChange });
        var endDateInputProps = __assign({ label: END_DATEINPUT_LABEL, format: this.props.format, min: this.min, max: this.max, id: this._endInputId, disabled: this.props.disabled }, this.props.endDateInputSettings, { value: value.end, onChange: this.handleEndChange });
        ...
        return (React.createElement("span", { ref: function (span) { _this._element = span; }, className: rootClassName, style: this.props.style, id: this.props.id, tabIndex: this.props.tabIndex, onFocus: this.handleFocus, onBlur: this.handleBlur, onKeyDown: this.handleKeyDown },
            React.createElement("span", { ref: function (span) { _this._wrapper = span; }, className: "k-daterangepicker-wrap", style: WRAPPER_STYLES },
                ...
                (this.props.allowReverse
                    ...
                    ? (React.createElement("span", __assign({ role: "button", className: "k-select k-button k-flat", title: kendo_react_intl_1.provideLocalizationService(this)
                        ...
                        React.createElement("span", { style: { transform: 'rotate(90deg)' }, className: "k-icon k-i-arrows-swap" }))) : (React.createElement("span", null, "\u00A0")),
