...
class ApproveDistributor extends Component {
    ...
    OnEditBankDetails(item) {
        let AccessToken = this.props.LoginDetails.accessToken;
        let PresentCreatingOrgType = 'PendingRetailer'
        this.props.GetOraganizationBanksToEdit(AccessToken, PresentCreatingOrgType, item);
    }
        ...
        return (
            <div className="animated fadeIn">
                ...
                {!this.props.ProgressIndicator.InProgress ?
                    <div>
                        <CustomerBreadCrumb from="ApproveRetailer" />
                        <ToastContainer position="top-right" autoClose={5000} style={{ zIndex: 1999 }} />
                        <Row>
                            <Col xs="12" lg="12">
                                <Card >
                                    <CardHeader>
                                        <h5 className="font-weight-bold"> Pending Retailers </h5>
                                    </CardHeader>
                                    <CardBody>
                                                            ...
                                                            <tr key={i + 1} >
                                                                ...
                                                                <td>
                                                                    <Input type="select"
                                                                        ...
                                                                        onChange={(txt) =>
                                                                            this.props.Save_ORG_RegistrationIpDetails(txt.target.value, 'RateCardId')
                                                                        }>
                                                                        <option value="">Select Rate Card</option>
                                                                        {(RateCardList.map((item, i) =>
                                                                ...
                                                                <td className="text-center">
                                                                    <Button type='button'
                                                                        onClick={() => {
                                                                            ...
                                                                            let RateCardId = this.props.OrganizationDetails.RegisteringOrg.RateCardId;
                                                                            let PresentCreatingOrgType = "AdminRetailer";
                                                                            if (RateCardId == "" || RateCardId == undefined) {
                                                                                this.props.OrgRegistrationInputWarnings("Please Select Ratecard", 'RateCardId')
                                                                            } else {
                                                                                this.props.ApproveOrganization(AccessToken, item.tenantIdentifier, RateCardId, PresentCreatingOrgType)
                                                                                this.props.NewlyAddedOrg.ApiResults.approveOrgSuccess ?
                                                                                    swal({
                                                                ...
                                                                <td>
                                                                    ...
                                                                    {<a style={{ marginLeft: 8 }} onClick={() => {
                                                                        this.props.Save_ORG_RegistrationIpDetails("PendingRetailer", "OrgType");
