            ...
            {/* <CustomerBreadCrumb from="RetailerTransactions"  /> */}
                          <div style={{display:"flex",justifyContent:"flex-start",margin:"1%"}}>
                            ...
                            <BootstrapTable data={ products } options={ options } pagination exportCSV>
                                    <TableHeaderColumn dataField='id' isKey={ true }>Retailer</TableHeaderColumn>
                                    <TableHeaderColumn dataField='transDate'  >Cashin By/Pullback By </TableHeaderColumn>
                                    <TableHeaderColumn dataField='debitAcId'>Amount</TableHeaderColumn>
                                    <TableHeaderColumn dataField='amount'>Date</TableHeaderColumn>
