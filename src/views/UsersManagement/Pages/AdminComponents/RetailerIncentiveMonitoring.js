        ...
        <div className="animated fadeIn">
            ...
            <CustomerBreadCrumb from="RetailerTransactions"  />
                          <div style={{display:"flex",justifyContent:"flex-start",margin:"1%"}}>
                                <Label style={{}}>Month   (Are two sections Required?)</Label>                      
                            </div>
                          <div style={{display:"flex",justifyContent:"flex-start",margin:"1%"}}>
                                <Label style={{marginRight:20}}>Retailer  </Label>
                                <Input type="select" style={{width:175}} >
                                  <option>select</option>
                                </Input>   
                                <Label style={{marginRight:20,marginLeft:20}}>Retailer Pan Number  </Label>
                                <Input type="select" style={{width:175}} >
                                  <option>select</option>
                                </Input>                              
                            </div>
                          <div style={{display:"flex",justifyContent:"flex-start",margin:"1%"}}>
                                <Label style={{width:70}}>Month  </Label>
                                <Input type="select" style={{width:175}} >
                                  <option>select</option>
                                </Input>                              
                            </div>
                            <div style={{display:"flex",justifyContent:"flex-start",margin:"1%"}}>
                                <Label style={{width:70}}>Monthly  </Label>
