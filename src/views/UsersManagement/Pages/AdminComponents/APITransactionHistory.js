...
class APITransactionHistory extends Component {
                                ...
                                <Card >
                                    <CardHeader>
                                            <div style={{display:"flex"}}> 
                                               <div style={{width:"50%"}}><h5 className="font-weight-bold"> API Transaction History</h5></div>
                                    ...
                                    <CardFooter>
                                            <div style={{display:"flex"}}> 
                                              <div style={{width:"100%", textAlign: "end"}}><Button className="warning"onClick={() => this.props.history.push("/APIPool")} >Cancel</Button></div>
                                            </div> 
                                    </CardFooter>
                                </Card>
                            </Col>
...
export default APITransactionHistory;
