    ...
    return (
      ...
      <div >
        <BootstrapTable data={products} options={options}  pagination={ true } exportCSV>
          <TableHeaderColumn dataField='Date' isKey={true}>Date and Time</TableHeaderColumn>
          <TableHeaderColumn dataField='Retailer'>Retailer</TableHeaderColumn>
          ...
          <TableHeaderColumn dataField='Transfered'>Transfered By</TableHeaderColumn>
