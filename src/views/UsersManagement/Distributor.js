...
import {
    // Get_Distributor_Basic_Details_To_Edit,
    // GetDistributorBanksToEdit,
...
class Distributor extends Component {
    ...
    OnEditBankDetails(item) {
        ...
        let AccessToken = this.props.LoginDetails.accessToken;
        let EditBankComponentFor = 'Distributor'
        this.props.OrganizationDetails.EditOrganizationDetails.EditBankComponentFor = 'Distributor';
        this.props.GetOraganizationBanksToEdit(AccessToken, EditBankComponentFor, item);
    }

    AddRetailersClicked() {
        this.props.Save_ORG_RegistrationIpDetails("Distributor", "OrgType");
        ...
        return (
            <div className="animated fadeIn">
                ...
                {!this.props.ProgressIndicator.InProgress ?
                    <div>
                        <CustomerBreadCrumb from="Distributor" contentPath="/ Management / Role" />
                        <Row>
                            <Col xs="12" lg="12">
                                <Card >
                                    <CardHeader>
                                        <h5 className="font-weight-bold">  Distributors</h5>
                                                    ...
                                                    this.props.OrganizationDetails.OrgList.map((user, i) => (
                                                        <tr key={i + 1} >
                                                            ...
                                                            <td className="text-center">
                                                                ...
                                                                {/* {user.active && this.props.LoginDetails.roleName !== "Admin" ? <a  onClick={() =>
                                                                    this.props.OrganiZationEditModal(user, 'UpdateWallet')}
                                                                    style={{cursor:"pointer",margin: 5}} >
                                                                    <i className="fa fa-credit-card fa-lg" title="Update Wallet" ></i>
                                                                </a> : null} */}

                                                                {user.active ? <a onClick={() => {
                                                                    // this.props.OrganizationDetails.EditOrgDocsFor = 'Distributor';
                                                                    this.props.Save_ORG_RegistrationIpDetails("Distributor", "OrgType");
